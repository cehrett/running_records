...
# Loop over all the subsets of the training data
for filenum in range(10):
	...
	# Set filepaths
	ASR_df_filepath = '/home/cehrett/running_records/repetition_data_generation/data/del_audio_subset_'+str(filenum)+'.csv'
	...
	trials_filename = 'scratch'+str(filenum)
